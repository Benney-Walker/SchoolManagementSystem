...
public class StudentResult {
    ...
    private List<StudentSubjectReport>  studentSubjectResults;

    public StudentResult(String studentId, String studentName, String className, String semesterName, Double totalScore,
                         Double averageScore, String position, List<StudentSubjectReport> studentSubjectResults) {
    ...
    public List<StudentSubjectReport> getStudentSubjectResults() {
        return studentSubjectResults;
    }

    public void setStudentSubjectResults(List<StudentSubjectReport> studentSubjectResults) {
        this.studentSubjectResults = studentSubjectResults;
    }
}
